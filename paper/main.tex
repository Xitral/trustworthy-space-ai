...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{horizon_timing.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{horizon_coverage.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{repeated_split_pr_auc.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{pr_auc_by_horizon.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{repeated_split_top5_recall.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{top5_recall_by_horizon.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{brier_score_by_horizon.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{ece_by_horizon.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{quantile_reliability_by_horizon.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{quantile_reliability_comparison_1d.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{uncertainty_positive_vs_negative.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{positive_escalation_rate.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{repeated_split_escalation_10pct.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{uncertainty_abstention_coverage.png}
...
\toprule
Horizon & Current-risk PR-AUC & GB with risk & GB without risk & With risk $-$ current & With risk $-$ without \\
\midrule
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{risk_ablation_pr_auc.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{risk_ablation_top5_recall.png}
